...
public class Library {
    public static void main(String[] args){
        ...
        readers.stream().forEach(i -> System.out.println(i.getBooks()));
        readers.stream().flatMap(i -> i.getBooks().stream()).distinct().forEach(i -> System.out.println(i));
        readers.stream().flatMap(i -> i.getBooks().stream());
